...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7900/2, 78.7900/2, 533.3333, 492.45/2} // these values are copied from orginal config file, the z axis is multiplied by 2 as the silent steppers are 16steps instead of 8 as per the guide
/*
...
#define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 22 } // ...or, set your own edit limits
#endif
