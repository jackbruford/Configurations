...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.7402/2, 78.7402/2, 533.3333, 492.45/2} // these values are copied from orginal config file, the z axis is multiplied by 2 as the silent steppers are 16steps instead of 8 as per the guide
/*
